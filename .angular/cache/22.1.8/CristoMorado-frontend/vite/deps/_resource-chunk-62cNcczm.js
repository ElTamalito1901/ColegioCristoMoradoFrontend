...
//#endregion
export { NG_PROV_DEF as $, updateAncestorTraversalFlagsOnAttach as $i, getInjectableDef as $n, keyValueArraySet as $r, assertParentView as $t, ENVIRONMENT_INITIALIZER as A, setThrowInvalidWriteToSignalError as Aa, setCurrentDirectiveIndex as Ai, fillProperties as An, isCurrentTNodeParent as Ar, assertFirstUpdatePass as At, INJECTOR_DEF_TYPES as B, setSelectedIndex as Bi, getComponentLViewByIndex as Bn, isInjectable as Br, assertLContainer as Bt, CheckNoChangesMode as C, consumerBeforeComputation as Ca, retrieveTransferredState as Ci, emitInjectorToCreateInstanceEvent as Cn, injectRootLimpMode as Cr, arraySplice as Ct, DestroyRef as D, getActiveConsumer as Da, scheduleCallbackWithRafRace as Di, enterSkipHydrationBlock as Dn, isComponentHost as Dr, assertElement as Dt, DOC_PAGE_BASE_URL as E, createComputed as Ea, scheduleCallbackWithMicrotask as Ei, enterDI as En, isComponentDef as Er, assertDomNode as Et, ErrorHandler as F, setInjectImplementation as Fi, getBindingIndex as Fn, isForwardRef as Fr, assertInInjectionContext as Ft, MATH_ML_NAMESPACE as G, storeLViewOnDestroy as Gi, getCurrentParentTNode as Gn, isRootView as Gr, assertNotDefined as Gt, INTERNAL_APPLICATION_ERROR_HANDLER as H, signalAsReadonlyFn as Hi, getContextLView as Hn, isLView as Hr, assertLessThan as Ht, EventEmitter as I, setInjectorProfiler as Ii, getBindingRoot as In, isInCheckNoChangesMode as Ir, assertIndexInDeclRange as It, NG_ELEMENT_ID as J, throwError as Ji, getCurrentTNodePlaceholderOk as Jn, isStandalone as Jr, assertNotReactive as Jt, NG_COMP_DEF as K, stringify as Ki, getCurrentQueryIndex as Kn, isSignal as Kr, assertNotEqual as Kt, IMAGE_CONFIG as L, setInjectorProfilerContext as Li, getBindingsEnabled as Ln, isInI18nBlock as Lr, assertIndexInExpandoRange as Lt, EffectRefImpl as M, setCurrentTNode as Mi, formatRuntimeError as Mn, isDirectiveHost as Mr, assertGreaterThan as Mt, EffectScheduler as N, setCurrentTNodeAsNotParent as Ni, forwardRef as Nn, isEnvironmentProviders as Nr, assertGreaterThanOrEqual as Nt, EMPTY_ARRAY as O, producerAccessed as Oa, setBindingIndex as Oi, enterView as On, isContentQueryHost as Or, assertEqual as Ot, EnvironmentInjector as P, setInI18nBlock as Pi, getAllSpecialProviders as Pn, isExhaustiveCheckNoChanges as Pr, assertHasParent as Pt, NG_PIPE_DEF as Q, unwrapRNode as Qi, getFactoryDef as Qn, keyValueArrayIndexOf as Qr, assertOneOf as Qt, IMAGE_CONFIG_DEFAULTS as R, setIsInCheckNoChangesMode as Ri, getClosureSafeProperty as Rn, isInInjectionContext as Rr, assertIndexInRange as Rt, ChangeDetectionScheduler as S, consumerAfterComputation as Sa, resolveForwardRef as Si, emitInjectEvent as Sn, inject as Sr, arrayInsert2 as St, DOCUMENT as T, consumerPollProducersForChange as Ta, runInInjectorProfilerContext as Ti, emitProviderConfiguredEvent as Tn, isClassProvider as Tr, assertDirectiveDef as Tt, InjectionToken as U, store as Ui, getCurrentDirectiveDef as Un, isProjectionTNode as Ur, assertNgModuleType as Ut, INJECTOR_SCOPE as V, signal as Vi, getConstant as Vn, isLContainer as Vr, assertLView as Vt, Injector as W, storeCleanupWithContext as Wi, getCurrentDirectiveIndex as Wn, isRefreshingViews as Wr, assertNodeInjector as Wt, NG_INJ_DEF as X, truncateMiddle as Xi, getDirectiveDefOrThrow as Xn, isWritableSignal as Xr, assertNumber as Xt, NG_FACTORY_DEF as Y, throwProviderNotFoundError as Yi, getDirectiveDef as Yn, isTypeProvider as Yr, assertNotSame as Yt, NG_MOD_DEF as Z, unwrapLView as Zi, getElementDepthCount as Zn, keyValueArrayGet as Zr, assertNumberInRange as Zt, untracked as _, ɵɵrestoreView as _a, removeFromArray as _i, debugStringifyTypeForError as _n, hasI18n as _r, ZONELESS_ENABLED as _t, ResourceParamsStatus as a, wasLastNodeCreated as aa, makeEnvironmentProviders as ai, assertTNodeCreationIndex as an, getNativeByTNode as ar, PROVIDED_ZONELESS as at, CONTAINER_HEADER_OFFSET as b, SIGNAL as ba, requiresRefreshOrTraversal as bi, effect as bn, incrementBindingIndex as br, angularZoneInstanceIdProperty as bt, computed as c, ɵɵdefineInjector as ca, markViewForRefresh as ci, attachInjectFlag as cn, getNgModuleDefOrThrow as cr, R3Injector as ct, invalidResourceCreationInParams as d, ɵɵinject as da, nextContextImpl as di, convertToBitFlags as dn, getOrCreateTViewCleanup as dr, SecurityContext as dt, validAppIdInitializer as ea, lastNodeWasCreated as ei, assertProjectionSlots as en, getInjectorDef as er, NgZone as et, isInParamsFunction as f, ɵɵinvalidFactoryDep as fa, promiseWithResolvers as fi, createInjector as fn, getPipeDef as fr, TransferState as ft, setInParamsFunction as g, ɵɵresetView as ga, registerSpecialProvider as gi, cyclicDependencyErrorWithDetails as gn, getTView as gr, XSS_SECURITY_URL as gt, rethrowFatalErrors as h, ɵɵnamespaceSVG as ha, providerToFactory as hi, cyclicDependencyError as hn, getTNode as hr, ViewContext as ht, ResourceImpl as i, walkUpViews as ia, load as ii, assertTNode as in, getNativeByIndex as ir, PLATFORM_INITIALIZER as it, ERROR_DETAILS_PAGE_BASE_URL as j, signalSetFn as ja, setCurrentQueryIndex as ji, flatten as jn, isDestroyed as jr, assertFunction as jt, EMPTY_OBJ as k, setActiveConsumer as ka, setBindingRootForHostBindings as ki, errorHandlerEnvironmentInitializer as kn, isCreationMode as kr, assertFirstCreatePass as kt, encapsulateResourceError as l, ɵɵdisableBindings as la, newArray as li, checkSecurityContext as ln, getNullInjector as lr, RuntimeError as lt, resource as m, ɵɵnamespaceMathML as ma, provideEnvironmentInitializer as mi, createViewEffect as mn, getSelectedTNode as mr, Version as mt, OutputEmitterRef as n, viewAttachedToContainer as na, leaveSkipHydrationBlock as ni, assertString as nn, getLViewParent as nr, NullInjector as nt, ResourceValueError as o, ɵunwrapWritableSignal as oa, makeStateKey as oi, assertTNodeForLView as on, getNativeByTNodeOrNull as or, PendingTasks as ot, linkedSignal as p, ɵɵnamespaceHTML as pa, provideBrowserGlobalErrorListeners as pi, createInjectorWithoutInjectorInstances as pn, getSelectedIndex as pr, VERSION as pt, NG_DIR_DEF as q, stringifyForError as qi, getCurrentTNode as qn, isSkipHydrationRootTNode as qr, assertNotInReactiveContext as qt, ResourceDependencyError as r, walkProviderTree as ra, leaveView as ri, assertTIcu as rn, getNamespace as rr, PLATFORM_ID as rt, chain as s, ɵɵdefineInjectable as sa, markAncestorsForTraversal as si, assertTNodeForTView as sn, getNgModuleDef as sr, PendingTasksInternal as st, CACHE_ACTIVE as t, viewAttachedToChangeDetector as ta, leaveDI as ti, assertSame as tn, getLView as tr, NoopNgZone as tt, getOutputDestroyRef as u, ɵɵenableBindings as ua, nextBindingIndex as ui, concatStringsWithSpace as un, getOrCreateLViewCleanup as ur, SCHEDULE_IN_ROOT_ZONE as ut, ANIMATION_MODULE_TYPE as v, setCurrentInjector as va, removeLViewOnDestroy as vi, decreaseElementDepthCount as vn, importProvidersFrom as vr, _global as vt, DEBUG_TASK_TRACKER as w, consumerDestroy as wa, runInInjectionContext as wi, emitInstanceCreatedByInjectorEvent as wn, internalImportProvidersFrom as wr, assertDefined as wt, CSP_NONCE as x, SIGNAL_NODE as xa, resetPreOrderHookFlags as xi, emitAfterRenderEffectPhaseCreatedEvent as xn, initNgDevMode as xr, arrayEquals as xt, APP_ID as y, REACTIVE_NODE as ya, renderStringify as yi, deepForEach as yn, increaseElementDepthCount as yr, addToArray as yt, INJECTOR$1 as z, setIsRefreshingViews as zi, getComponentDef as zn, isInSkipHydrationBlock as zr, assertInjectImplementationNotEqual as zt };
