import { $ as NG_PROV_DEF, $i as updateAncestorTraversalFlagsOnAttach, $r as keyValueArraySet, $t as assertParentView, A as ENVIRONMENT_INITIALIZER, Aa as setThrowInvalidWriteToSignalError, Ai as setCurrentDirectiveIndex, An as fillProperties, Ar as isCurrentTNodeParent, At as assertFirstUpdatePass, B as INJECTOR_DEF_TYPES, Bi as setSelectedIndex, Bn as getComponentLViewByIndex, Bt as assertLContainer, C as CheckNoChangesMode, Ca as consumerBeforeComputation, Ci as retrieveTransferredState, Cn as emitInjectorToCreateInstanceEvent, Cr as injectRootLimpMode, Ct as arraySplice, D as DestroyRef, Da as getActiveConsumer, Di as scheduleCallbackWithRafRace, Dn as enterSkipHydrationBlock, Dr as isComponentHost, Dt as assertElement, E as DOC_PAGE_BASE_URL, Ea as createComputed, Ei as scheduleCallbackWithMicrotask, En as enterDI, Er as isComponentDef, Et as assertDomNode, F as ErrorHandler, Fi as setInjectImplementation, Fn as getBindingIndex, Fr as isForwardRef, Ft as assertInInjectionContext, G as MATH_ML_NAMESPACE, Gi as storeLViewOnDestroy, Gn as getCurrentParentTNode, Gr as isRootView, Gt as assertNotDefined, H as INTERNAL_APPLICATION_ERROR_HANDLER, Hi as signalAsReadonlyFn, Hn as getContextLView, Hr as isLView, Ht as assertLessThan, Ii as setInjectorProfiler, In as getBindingRoot, Ir as isInCheckNoChangesMode, It as assertIndexInDeclRange, J as NG_ELEMENT_ID, Ji as throwError, Jn as getCurrentTNodePlaceholderOk, Jr as isStandalone, Jt as assertNotReactive, K as NG_COMP_DEF, Ki as stringify, Kn as getCurrentQueryIndex, Kr as isSignal, Kt as assertNotEqual, L as IMAGE_CONFIG, Li as setInjectorProfilerContext, Ln as getBindingsEnabled, Lr as isInI18nBlock, Lt as assertIndexInExpandoRange, M as EffectRefImpl, Mi as setCurrentTNode, Mn as formatRuntimeError, Mr as isDirectiveHost, Mt as assertGreaterThan, N as EffectScheduler, Ni as setCurrentTNodeAsNotParent, Nn as forwardRef, Nt as assertGreaterThanOrEqual, O as EMPTY_ARRAY, Oa as producerAccessed, Oi as setBindingIndex, On as enterView, Or as isContentQueryHost, Ot as assertEqual, P as EnvironmentInjector, Pi as setInI18nBlock, Pn as getAllSpecialProviders, Pr as isExhaustiveCheckNoChanges, Pt as assertHasParent, Q as NG_PIPE_DEF, Qi as unwrapRNode, Qn as getFactoryDef, Qr as keyValueArrayIndexOf, Qt as assertOneOf, Ri as setIsInCheckNoChangesMode, Rn as getClosureSafeProperty, Rr as isInInjectionContext, Rt as assertIndexInRange, S as ChangeDetectionScheduler, Sa as consumerAfterComputation, Si as resolveForwardRef, Sn as emitInjectEvent, Sr as inject, St as arrayInsert2, T as DOCUMENT$1, Ta as consumerPollProducersForChange, Ti as runInInjectorProfilerContext, Tn as emitProviderConfiguredEvent, Tr as isClassProvider, Tt as assertDirectiveDef, U as InjectionToken, Ui as store, Un as getCurrentDirectiveDef, Ur as isProjectionTNode, Ut as assertNgModuleType, V as INJECTOR_SCOPE, Vi as signal, Vn as getConstant, Vr as isLContainer, Vt as assertLView, W as Injector, Wi as storeCleanupWithContext, Wn as getCurrentDirectiveIndex, Wr as isRefreshingViews, Wt as assertNodeInjector, X as NG_INJ_DEF, Xn as getDirectiveDefOrThrow, Xr as isWritableSignal, Xt as assertNumber, Y as NG_FACTORY_DEF, Yi as throwProviderNotFoundError, Yn as getDirectiveDef, Yr as isTypeProvider, Yt as assertNotSame, Z as NG_MOD_DEF, Zi as unwrapLView, Zn as getElementDepthCount, Zr as keyValueArrayGet, Zt as assertNumberInRange, _ as untracked, _a as ɵɵrestoreView, _i as removeFromArray, _n as debugStringifyTypeForError, _r as hasI18n, _t as ZONELESS_ENABLED, aa as wasLastNodeCreated, ai as makeEnvironmentProviders, an as assertTNodeCreationIndex, ar as getNativeByTNode, at as PROVIDED_ZONELESS, ba as SIGNAL, bi as requiresRefreshOrTraversal, bn as effect, br as incrementBindingIndex, bt as angularZoneInstanceIdProperty, c as computed, ca as ɵɵdefineInjector, ci as markViewForRefresh, cn as attachInjectFlag, cr as getNgModuleDefOrThrow, ct as R3Injector, d as invalidResourceCreationInParams, da as ɵɵinject, di as nextContextImpl, dn as convertToBitFlags, dr as getOrCreateTViewCleanup, dt as SecurityContext, ea as validAppIdInitializer, ei as lastNodeWasCreated, en as assertProjectionSlots, er as getInjectorDef, et as NgZone, f as isInParamsFunction, fa as ɵɵinvalidFactoryDep, fi as promiseWithResolvers, fr as getPipeDef$1, ft as TransferState, g as setInParamsFunction, ga as ɵɵresetView, gi as registerSpecialProvider, gn as cyclicDependencyErrorWithDetails, gr as getTView, gt as XSS_SECURITY_URL, h as rethrowFatalErrors, ha as ɵɵnamespaceSVG, hi as providerToFactory, hn as cyclicDependencyError, hr as getTNode, ht as ViewContext, ia as walkUpViews, ii as load, in as assertTNode, ir as getNativeByIndex, it as PLATFORM_INITIALIZER, j as ERROR_DETAILS_PAGE_BASE_URL, ja as signalSetFn, ji as setCurrentQueryIndex, jn as flatten, jr as isDestroyed, jt as assertFunction, k as EMPTY_OBJ, ka as setActiveConsumer, ki as setBindingRootForHostBindings, kn as errorHandlerEnvironmentInitializer, kr as isCreationMode, kt as assertFirstCreatePass, la as ɵɵdisableBindings, li as newArray, ln as checkSecurityContext, lr as getNullInjector, lt as RuntimeError, ma as ɵɵnamespaceMathML, mi as provideEnvironmentInitializer, mn as createViewEffect, mr as getSelectedTNode, n as OutputEmitterRef, na as viewAttachedToContainer, ni as leaveSkipHydrationBlock, nn as assertString, nr as getLViewParent, nt as NullInjector, o as ResourceValueError, oi as makeStateKey, on as assertTNodeForLView, or as getNativeByTNodeOrNull, ot as PendingTasks, p as linkedSignal, pa as ɵɵnamespaceHTML, pn as createInjectorWithoutInjectorInstances, pr as getSelectedIndex, pt as VERSION, q as NG_DIR_DEF, qi as stringifyForError, qn as getCurrentTNode, qr as isSkipHydrationRootTNode, qt as assertNotInReactiveContext, ra as walkProviderTree, ri as leaveView, rn as assertTIcu, rr as getNamespace, sa as ɵɵdefineInjectable, si as markAncestorsForTraversal, sn as assertTNodeForTView, sr as getNgModuleDef, st as PendingTasksInternal, ta as viewAttachedToChangeDetector, ti as leaveDI, tn as assertSame, tr as getLView, tt as NoopNgZone, ua as ɵɵenableBindings, ui as nextBindingIndex, un as concatStringsWithSpace, ur as getOrCreateLViewCleanup, ut as SCHEDULE_IN_ROOT_ZONE, vi as removeLViewOnDestroy, vn as decreaseElementDepthCount, vt as _global, w as DEBUG_TASK_TRACKER, wa as consumerDestroy, wi as runInInjectionContext, wn as emitInstanceCreatedByInjectorEvent, wr as internalImportProvidersFrom, wt as assertDefined, xa as SIGNAL_NODE, xi as resetPreOrderHookFlags, xn as emitAfterRenderEffectPhaseCreatedEvent, xr as initNgDevMode, xt as arrayEquals, y as APP_ID, ya as REACTIVE_NODE, yi as renderStringify, yn as deepForEach, yr as increaseElementDepthCount, yt as addToArray, z as INJECTOR$1, zi as setIsRefreshingViews, zn as getComponentDef, zr as isInSkipHydrationBlock$1, zt as assertInjectImplementationNotEqual } from "./_resource-chunk-62cNcczm.js";
...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
	const tAttributes = rootSelectorOrNode ? ["ng-version", "22.1.6"] : extractAttrsAndClassesFromSelector(componentDef.selectors[0]);
...
function getBaseDocUrl() {
	...
	return `https://${full.includes("-next") || full.includes("-rc") || full === "22.1.6" ? "next" : `v${VERSION.major}`}.angular.dev`;
}
